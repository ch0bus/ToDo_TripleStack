...
| Путь | Описание |
|------|----------|
| `/` | Входящие; «+ Добавить»; события дня в «Сегодня»; сортировка в «Все задачи» (`?sort=`) |
...
| `/calendar` | Календарь; доска смен `?calendar=id`; сводка смен с меню настроек и рисования; «Задачи месяца» и «События месяца» |
| `/settings` | Профиль, теги, тема, ссылка на настройки смен |

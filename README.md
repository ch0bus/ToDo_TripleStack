...
- Событие: отдельная сущность (встреча, день рождения); без статуса и срока; на входящих в блоке выбранного дня; на календаре — цветная полоска и список «События месяца»

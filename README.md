...
- Событие: отдельная сущность (встреча, день рождения); без статуса и срока; на входящих в блоке выбранного дня; на календаре — цветная полоска, сетка часов (день/неделя) и список «События месяца»
- Заметка дня: одна на дату; на месяце — золотая полоска; во входящих — золотая рамка
- Календарь: виды день / неделя / месяц / год; день и неделя — сетка часов для событий; месяц — полоски; год — точка занятости; смены — диагональная заливка двух слоёв

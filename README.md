...
- Заметка дня: одна на дату, золотая рамка на календаре и во входящих
- Календарь месяца и года: задачи, события (закладка / квадрат), смены (диагональная заливка двух слоёв)

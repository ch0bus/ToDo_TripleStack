...
- Календарь месяца: сроки, превью повторов, свои смены (заливка дня)
- Повтор: шаг daily / weekly / monthly **от даты создания до срока**; без срока на календаре не рисуется; при «Готово» копия не создаётся

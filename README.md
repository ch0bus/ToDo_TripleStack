...
Данные **личные**: задачи, события, заметки, теги и смены принадлежат аккаунту из JWT. Общего списка или общего календаря нет. Системные теги (работа, дом и т.п.) видят все, но задачи с ними остаются у владельца; в настройках их можно скрывать по одному из меню и форм.
